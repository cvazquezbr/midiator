...
export default HomePage;import AudioGenerator from '../components/AudioGenerator';
import VideoGenerator2 from '../components/VideoGenerator2';
import PostsCurtosStep from '../components/PostsCurtosStep';
import CsvInfobox from '../components/CsvInfobox';
import Publisher from '../components/Publisher';
...
function HomePage() {
  ...
  const campaignData = useMemo(() => ({
    ...
    customPalette,
    imageColorPalette,
  }), [problema, solucao, objetivo, tomDeVoz, campaignContent, followupPosts, generatedPageUrl, csvData, csvHeaders, fieldPositions, fieldStyles, brandElements, pageTemplate, generatedPagesData, generatedVideos, generatedAudioData, aspectRatio, fontScale, templateFieldStyles, paletteId, customPalette, imageColorPalette]);
...
export default HomePage;import { parseIaResponseToCsvData } from '../utils/iaResponseParser.js';
import { parseCsv } from '../utils/csvParser.js';
import { lightTheme, darkTheme } from '../theme.js';
import ColorThief from 'colorthief';
import { drawAndComposeImage, getDimensionsFromAspectRatio } from '../utils/imageComposer.js';

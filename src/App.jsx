...
// Componentes locais (serão adaptados/refatorados)
import FieldPositioner from './components/FieldPositioner';
// import ImageGeneratorFrontendOnly from './components/ImageGeneratorFrontendOnly'; // Será integrado depois
...
const DesignStep = ({ backgroundImage, csvHeaders, fieldPositions, setFieldPositions, fieldStyles, setFieldStyles, csvData, onImageDisplayedSizeChange, colorPalette }) => {
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
          <div className="xl:col-span-3 bg-gray-50 rounded-lg p-2">
            {backgroundImage ? <FieldPositioner {...{backgroundImage, csvHeaders, fieldPositions, setFieldPositions, fieldStyles, setFieldStyles, csvData, onImageDisplayedSizeChange, colorPalette, onFieldSelect: handleFieldSelect, selectedField: selectedFieldForStyling}}/>
...
@@ -463,15 +250,15 @@
                       onImageDisplayedSizeChange={setDisplayedImageSize} // Passando o setter diretamente

...
const LinkedinAuthSetup = ({ onBeforeRedirect }) => {
  ...
  const handleConnect = async () => {
    if (clientId) {
      ...
      const redirectUri = window.location.origin;
      const scope = encodeURIComponent('r_basicprofile r_organization_social w_member_social w_organization_social rw_organization_admin r_organization_social_analytics r_member_social');
